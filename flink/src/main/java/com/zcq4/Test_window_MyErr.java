...
//滚动时间窗口,计算最近10秒数据的WordCount,默认取的是
public class Test_window_MyErr {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //5.开窗
        WindowedStream<SensorReading, Tuple, TimeWindow> windowedStream = keyedStream.timeWindow(Time.seconds(50));
